...
public class week1 {
	/*
	 ...
	 boolean Result = false ;    
	  ...
	  B. do {  System.out.println("Hello Batch 11");  }  while(Result); 
	...
	/*
	 ...
	 what does replacefirst() method do in string?
	 	A. replaces the first occurrence with the given argument 
